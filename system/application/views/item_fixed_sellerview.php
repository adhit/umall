    ...
    <table class="table table-bordered t-items">
          ...
          <tr>
          	<td colspan="2">
                ...
                <ul class="itemlog">
                    <li><a href=#>reinardus</a>  bought 1 item at S30 each. <span class="timestamp">05.50 am</span></li><hr>
                    <li><a href=#>user001</a> bought 2 items at S$30 each. <span class="timestamp">05.50 am</span></li><hr>
                    <li><a href=#>ahnjotoh1</a>  bought 1 item at S30 each. <span class="timestamp">05.50 am</span></li><hr>
                    <li><a href=#>evanpy1</a> bought 2 items at S$30 each. <span class="timestamp">05.50 am</span></li><hr>
                </ul>
            </td>
            <td class="owner">
            	<h3 class="owner-text">You are the seller of this item.</h3><br>
                <div class="btn btn-large btn-inverse"><i class="icon-pencil icon-white"></i> Edit Item</div> 
            </td>
           </tr>
      </table>
    </div> <!-- /container -->
