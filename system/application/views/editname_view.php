...
<?php include "includes/header.php"; ?>
    ...
    <h1 class="content-header">Edit your name</h1>
	...
	<?php } ?>
   	...
   	<div class="row">
    	<form class="form-horizontal" action="<?php echo site_url()."/user/editname"; ?>" method="post">
		<input type="hidden" name="filled" value="yes">
        <div class="span6 offset3">
            <div class="control-group<?php if(isset($msg['phone_error'])) echo " error"; ?>">
              <label class="control-label" for="input01">Name</label>
              <div class="controls">
                <input type="text" name="phone" class="input-large input-xlarge" id="input01" value="<?php if(!$this->input->post('phone')) echo $user['name']; else echo $this->input->post('phone'); ?>">
              </div>
        		</div>
        		<hr>
